...
permalink: /coder/javascript/fnm_ready.html
---
...
因为我 Windows 开发环境一直使用的是 [WSL 子系统](/misc/wsl_ready.html) ，如果 Windows 环境需要使用 nodejs 我建议直接下载 `.msi` 安装包进行使用。

详情可参考 [nodejs 基础环境搭建](/coder/javascript/nodejs_ready.html)
